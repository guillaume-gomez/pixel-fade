...
const PixelsFadeMaterialPoint = shaderMaterial(
  { 
    uTexture: null,
  ...
  /*glsl*/`
    ...
    void main(){
        ...
        finalPosition.x += -uTextureSize.x/2. + speed * noise.x;
        finalPosition.y += -uTextureSize.y/2. + speed * noise.y;
        finalPosition.z += sin(uTime * speed);
...
export default PixelsFadeMaterialPoint;
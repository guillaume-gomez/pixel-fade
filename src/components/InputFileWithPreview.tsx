...
function InputFileWithPreview({onChange, value} : InputFileWithPreviewProps) {
  ...
  return (
    <div className="flex gap-3" style={{maxHeight: "72px"}}>
      <label className="btn-custom text-lg w-full flex flex-col justify-center items-center bg-black text-primary shadow-lg tracking-wide uppercase border-2 rounded-xl border-primary transition duration-300 ease-in-out bg-opacity-80 cursor-pointer hover:bg-primary hover:text-black">
